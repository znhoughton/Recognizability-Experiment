...
Usage-based theories posit that some complex phrases (e.g., multi-word expressions) may be stored holistically in memory, arguing that storage is driven by usage-based factors (e.g., the distribution of the input language). For example, factors like frequency or predictability of the phrase may influence whether the phrase is stored holistically or not. According to these theories, multi-word phrases such as *I don't know* could be stored holistically if they are used frequently enough. In other words, frequency of use may lead to compositional items, e.g., multi-word phrases, being stored as a holistic unit which can be accessed from memory [e.g., @kapatsinski2018; @kapatsinski2009; @hay2001; @lee2015; @arnon2010; @stemberger1986; @stemberger2004; @morgan2016; @tomasello2005; @ambridgeStoredAbstractionsRadical2020].
