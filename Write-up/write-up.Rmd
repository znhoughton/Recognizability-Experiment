...
Throughout the years different theories have argued for different degrees of holistic storage. Two theories in particular have dominated the field: Chomskyan theories [e.g., @chomskyAspectsTheorySyntax1965], which propose that only necessary items (e.g., items that can't be formed compositionally) are stored, and usage-based theories [e.g., @bybee2003], which propose that multi-word items can be stored under certain usage-based conditions, such as frequency of use.
