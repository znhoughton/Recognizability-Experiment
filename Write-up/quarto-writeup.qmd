...
The model syntax for both models is included below in Equations @eq-brmsFreq and @eq-brmsPredic:
...
#| fig-cap: "Visualization of the model results from Table @tbl-brmsQuadraticNoInter for frequency (top) and predictability (bottom). Frequencies are per million."
